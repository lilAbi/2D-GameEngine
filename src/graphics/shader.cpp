...
#include "shader.h"
/*
Shader::Shader(std::string_view vertShaderFilePath, std::string_view fragShaderFilePath) {
...
void Shader::CheckForErrors(unsigned int shader, std::string_view type) {
    int flag;
    char log[1024];
